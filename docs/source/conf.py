...
autodoc_mock_imports = ['base', 'ROOT', "numpy", "sklearn", "pathos", "tensorflow", "tabulate", "root_numpy", "pyAMI", "pandas",
                        'mock']
...
latex_documents = [
    (master_doc, 'PyAnalysisTools.tex', u'PyAnalysisTools Documentation',
